...
\keywordsEN{regex, backreference, Turing machine, ref-word, regex matching problem, NP-completeness proof, parametrized complexity, active variable, implementation, C++, test set creation, grep, Perl}
...
\begin{figure}
	Obsah CD je dostupný také na \url{https://gitlab.fit.cvut.cz/zaporole/regex_matcher}.
	\newline
	\dirtree{%
